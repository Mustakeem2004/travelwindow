    ...
    const checkclickoutside=(event)=>{
      if(filterIconref.current && 
        !filterIconref.current.contains(event.target) &&
         filterData.current && 
        !filterData.current.contains(event.target)
      ){
  ...
  return (
    <div style={{ display:"flex",flexDirection:"column",alignItems:"center" }}>
      ...
      <div style={{ display: "flex", gap: "20px"}}>
        <div ref={filterData}  className={`filters-wrapper ${showFilters ? "show" : ""}`} >
        ...
        <div  className="nameCard">
          ...
          <h1>{city.toUpperCase()}</h1>
           <h4 ref={filterIconref}  className="filterIcon" onClick={toggleFilters}><img style={{width:"20px"}} src={filterIcon} alt="" /> Filters</h4>
